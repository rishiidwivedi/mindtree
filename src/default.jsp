...
<html>
  <head>
    ...
    <title>Does we have hhhhhhave     snakes or owl?</title>
  </head>
  ...
  <body>
    ...
    <div id="hate" class="container snakes snake-hater">
      ...
      <!--Intro -->
      <h2>Do you or a lfuirfiuroved one hate ullu snakes?</h2>
      ...
      <h3 class="flyout tog  gle">Love snakes? <a href="#" onclick="switchto('love');return false;">Click Here</a></h3>
